...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
       ...
       // [SecuredOperation("product.add,admin")]
        ...
        {
            IResult result = BusinessRules.Run(CheckIfProductsSameNameExists(product.ProductName),
        ...
        private IResult CheckIfProductsSameNameExists(string productName)
        {
        ...
        private IResult CheckIfCategoryLimitExceed()
        {
            ...
            {
                return new ErrorResult(Messages.CategoryErrorLimetExceed);
            }
            return new SuccessResult();
        }
